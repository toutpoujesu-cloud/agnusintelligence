/* =====================================================================
   AGNUS Academy Â· Curriculum data layer
   ---------------------------------------------------------------------
...
(function () {
  ...
  var ITEMS = [
    ...
    ['CP23','L3','Level 2â€“3 Checkpoint','AGNUS - Academy Level 2-3 Checkpoint.html','checkpoint'],
  ...
  // [minutes, steps] per item â€” used by the panel and the dashboard
  var META = {"M01":[15,["Understand","See","Practice","Pass"]],"M02":[18,["Understand","The anatomy of the difference","Same question. Two very different systems.","Why the distinction governs everything","Practice","Pass â€” hidden test"]],"M03":[16,["Understand","Every tool call has four parts","Agents issue tool calls in sequence","Recognising a suspicious tool call","Practice","Pass â€” hidden test"]],"M04":[16,["Understand","The four types of AI memory","How memory changes what an agent does","Memory and governance","Practice","Pass â€” hidden test"]],"M05":[15,["Understand","What confidence actually signals in an AI","The spectrum of AI errors","The first deviation â€” what changes at AGNUS","Practice","Pass â€” hidden test"]],"M06":[16,["Understand","Five elements of a reasoning trace","Reading a trace with a problem","Red flags in reasoning traces","Practice","Pass â€” hidden test"]],"M07":[15,["Understand","How a model generates text","Three mechanisms that produce wrong-but-confident output","What to do differently","Practice","Pass â€” hidden test"]],"CP1":[10,["Answer the questions","See your result"]],"M08":[20,["Understand","The pre-run checklist","Configure your first task","Reviewing agent output after a task run","Practice","Pass â€” hidden test"]],"M09":[16,["Understand","Tracing the root causes","The three root causes","What a better brief looks like","Practice","Pass â€” hidden test"]],"M10":[10,[]],"M11":[16,["Understand","Six common failure patterns","Diagnosing from symptoms","Prevention over detection","Practice","Pass â€” hidden test"]],"M12":[14,["Understand","Safe to retry vs dangerous to retry","The retry decision framework","Configuring retry behaviour in the brief","Practice","Pass â€” hidden test"]],"M13":[14,["Understand","Three validation layers","Validation in practice","A worked validation example","Practice","Pass â€” hidden test"]],"M14":[14,["Understand","A clean handoff chain","How handoffs fail","Four rules for clean handoffs","Practice","Pass â€” hidden test"]],"M15":[10,[]],"M16":[10,["Understand","Direct","Pass"]],"M17":[16,["Understand","Four types of scope constraint","With and without scope constraints","Build a scope constraint set","Practice","Pass â€” hidden test"]],"M18":[15,["Understand","Anatomy of an approval gate","Trigger conditions for approval gates","Gate simulation â€” make the approval decision","Practice","Pass â€” hidden test"]],"M19":[16,["Understand","Orchestrator and subagent","Three coordination patterns","Multi-agent risks","Practice","Pass â€” hidden test"]],"M20":[14,["Understand","The instruction hierarchy","Conflicts in practice","Writing the hierarchy into the brief","Practice","Pass â€” hidden test"]],"M21":[14,["Understand","What triggers escalation","Anatomy of an escalation path","What breaks an escalation path","Practice","Pass â€” hidden test"]],"CP23":[10,["Answer the questions","See your result"]],"M22":[16,["Understand","Reading a real execution log","The five-step governance log scan","Find the governance issue in this log","What good log coverage looks like","Pass â€” hidden test"]],"M23":[16,["Understand","The three stages of scope drift","A real drift scenario â€” traced step by step","The scope drift detection checklist","Practice","Pass â€” hidden test"]],"M24":[15,["Understand","Anatomy of a complete authority chain","The five authority chain analysis questions","Broken authority chains","Practice","Pass â€” hidden test"]],"M25":[15,["Understand","See","Practice","Pass"]],"M26":[25,["Understand","See","Classify","Observe","Diagnose","Pass"]],"M26b":[12,["Why agents need escalation paths","The three escalation levels","Escalation triggers","Who receives the escalation","Practice","Pass â€” hidden test"]],"M27":[16,["Understand","The four policy layers","A complete policy architecture â€” worked example","Handling policy conflicts","Practice","Pass â€” hidden test"]],"M28":[18,["Understand","Five workspace principles","Live instruction builder","Versioning and the review process","Practice","Pass â€” hidden test"]],"CP4":[10,["Answer the questions","See your result"]],"M29":[16,["Understand","Four causes of a stuck agent","Diagnosing from what the agent says","Three real scenarios","Practice","Pass â€” hidden test"]],"M30":[16,["Understand","Four types of financial claim â€” and how to verify each","The five-step financial claim verification standard","A worked verification example","Practice","Pass â€” hidden test"]],"M31":[15,["Understand","Five marketing claim categories","The incident â€” traced step by step","The substantiation standard","Practice","Pass â€” hidden test"]],"M32":[15,["Understand","The legal draft risk matrix","What lawyers catch that AI misses","Writing the approval boundary into the brief","Practice","Pass â€” hidden test"]],"M33":[15,["Understand","What contested looks like â€” three examples","Identifying contested territory","How to handle contested output","Practice","Pass â€” hidden test"]],"M34":[15,["Understand","Five logical errors in AI data analysis","The five conclusion verification questions","A worked walkthrough","Practice","Pass â€” hidden test"]],"M35":[16,["Understand","How instructions differ for customer-facing agents","A complete customer-facing instruction set","Common instruction gaps in customer-facing agents","Practice","Pass â€” hidden test"]],"CP5":[10,["Answer the questions","See your result"]],"M36a":[16,["Understand","The four application layers","Where agents live in the application stack","A request flowing through the stack","Practice","Pass â€” hidden test"]],"M36b":[15,["Understand","Three architecture decisions that matter most","The architecture decision framework","Instructing AI on architecture choices","Practice","Pass â€” hidden test"]],"M36c":[15,["Understand","The six-step scaffold sequence","Good vs. poor scaffold briefs","Reviewing scaffold output","Practice","Pass â€” hidden test"]],"M36d":[14,["Understand","Six architecture review categories","A structured review walkthrough","The configuration vs. code principle","Practice","Pass â€” hidden test"]],"M36e":[25,["Understand","The four build phases and their gates","The assignment","Build reflection","Practice","Pass â€” hidden test"]],"M36f":[10,[]],"M36g":[10,[]],"M37":[25,["Understand","Four types of guardrail","Guardrail anatomy â€” three components","Build your first guardrail","Practice","Pass â€” hidden test"]],"M38":[25,["Understand","The specification","The working checker â€” test it now","How to build this with AI","Practice","Pass â€” hidden test"]],"M39":[25,["Understand","What a verifiable video brief contains","Build your verified video brief","Directing AI to write a verifiable brief","Practice","Pass â€” hidden test"]],"M40":[15,["Understand","See","Build","Pass"]],"M41":[15,["Understand","See","Build","Pass"]],"M42":[10,["The verification problem","Four validity criteria","Two test case types every suite needs","Practice","Pass"]],"M42b":[15,["Understand","See","Build","Pass"]],"CP6":[10,["Answer the questions","See your result"]],"M43":[10,["Understand","Govern","Pass"]],"M44":[15,["Understand","See","Practice","Pass"]],"M45":[15,["Understand","See","Practice","Pass"]],"M46":[15,["Understand","See","Practice","Pass"]],"M47":[15,["Understand","See","Build","Pass"]],"M48":[15,["Understand","See","Practice","Pass"]],"CP7":[10,["Answer the questions","See your result"]],"M49":[10,[]],"L8-01":[15,["Understand","See","Practice","Pass"]],"L8-02":[15,["Understand","See","Practice","Pass"]],"L8-03":[15,["Understand","See","Practice","Pass"]],"L8-04":[15,["Understand","See","Practice","Pass"]],"L8-05":[15,["Understand","See","Practice","Pass"]],"L8-06":[15,["Understand","See","Practice","Pass"]],"L8-06b":[15,["Understand","See","Practice","Pass"]],"L8-07":[15,["Understand","See","Practice","Pass"]],"L8-08":[25,["Understand","Vision Capture","Blueprint Generation","Refinement","Final Plan & Tools","Practice & Pass"]],"L8-09":[25,["Understand","Track 1: Behavior","Track 2: Aesthetics","The Claude Aesthetic Trap","Designer-in-Chief","Practice & Pass"]],"L8-10":[30,["Understand","What a Real Structure Looks Like","Step 1: The Diagram","Recognizing a Good Structure","Letting Claude Choose the Stack","Asking for the Full Document","Judging the Result"]],"L8-11":[30,["Understand","Chat and Canvas","Step 1: Design System","Step 2: The Four-Part Prompt","Step 3: Refining","Step 4: Handoff","Step 5: Context & Testing","Deliverable & Practice"]],"L8-12":[30,["Understand","The Handoff Bundle","The IKEA Model","Two Commands","The Handoff Contract","The Assembly Guide","An Honest Limitation","Practice"]],"L8-13":[30,["Understand","The Physical Folder","Populating The Protocol","Placing the Design Files","\"Read Everything\"","Filling the Gaps","Governor, Not Builder","Practice"]],"L8-14":[35,["Understand","Generating Every Scenario","Testing Every Scenario","Fixing What Failed","All Green, First Pass","Bringing In Codex","What the External Audit Caught","Closing the Loop","Practice"]],"CP8":[10,["Answer the questions","See your result"]],"L8-DONE":[10,[]]};
  ...
  /* â”€â”€ storage (replace with a real backend before launch) â”€â”€ */
  function load() {
  ...
  /* â”€â”€ where the student is inside the current page â”€â”€ */
  ...
  function render() {
    ...
    if (!isUnlocked(it)) {
      ...
      lock.innerHTML = '<div class="al-card"><h2>This lesson is locked</h2>'
        + '<p>Finish <b>' + p.id + ' â€” ' + p.title + '</b> first. Each lesson builds on the one before it.</p>'
        + '<button id="alGo">Go to ' + p.id + ' â†’</button><button class="sec" id="alDash">Dashboard</button></div>';
    ...
    panel.innerHTML = '<div class="ap-head" id="apHead"><div><div class="ap-k">' + it.level + ' Â· ' + levelName(it.level) + ' Â· ' + lp.done + '/' + lp.total + ' done</div>'
      + '<div class="ap-t">' + it.id + ' â€” ' + it.title + '</div><div class="ap-s" id="apStep">' + stepLine(it) + '</div></div><span class="ap-tog">' + (panel.className === 'min' ? 'â–´' : 'â–¾') + '</span></div>'
      + '<div class="ap-body"><div class="ap-bar"><div class="ap-fill" style="width:' + lp.pct + '%"></div></div>'
      + (done ? '<div class="ap-done">âœ“ Completed</div>' : '')
      + '<div class="ap-row">'
      + '<button id="apPrev"' + (pv ? '' : ' disabled') + '>â† Prev</button>'
      + (isCheckpoint && !done
          ? '<button class="pri" disabled title="Pass the checkpoint to continue">Pass to continue</button>'
          : '<button class="pri" id="apNext">' + (done ? (n ? 'Next: ' + n.id + ' â†’' : 'Dashboard â†’') : (n ? 'Complete & continue â†’' : 'Complete â†’')) + '</button>')
      + '</div></div>';
  ...
  function hookDashboardButtons() {
    ...
    document.querySelectorAll('button.tr-btn').forEach(function (btn) {
      if (/App\.html/.test(btn.getAttribute('onclick') || '') && !btn.closest('header')) {
        btn.textContent = n ? ('Next: ' + n.id + ' â†’') : 'â† Dashboard';
